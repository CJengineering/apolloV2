...
<div className="">
<h1 className="header-article w-2/3"><span className="font-bold">2023 Graduation Collection:</span> <br></br>
...
<div className="my-6">
<ButtonCJ text="Download PDF version" href="/documents/jameel-house-cairo-catalogue-2023/JameelHouseCatalogue_2023_WEB_LOW.pdf" styleType="secondary" />
</div>
</div>
