        ...
        <div className="flex flex-col text-left">
          ...
          <div className="w-full">
            <div className="prose prose-xl leading-normal dark:prose-dark">
              <p>
              In 2024, Community Jameel continued to advance its mission across emergency humanitarian relief, climate action, water and food systems, disease modelling, AI and health, learning, traditional arts and arts and health, making significant strides through its global programmes and partnerships. The MIT Jameel Clinic led breakthroughs in AI-driven medical research, while collaborations with Imperial College London and Save the Children supported vital emergency responses and healthcare training. The Jameel Observatory-CREWSnet expanded its reach, enhancing resilience to climate shocks in vulnerable regions, and the MIT Jameel-Toyota Scholarship marked its 30th year of empowering students worldwide.
              </p>
              <p>
