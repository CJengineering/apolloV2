        ...
        <div className="flex flex-col text-left">
          ...
          <div className="w-full">
            <div className="prose prose-xl leading-normal dark:prose-dark">
              <p>
                Community Jameel Studios produces award-winning films and video
                content about how science and learning can help communities
                thrive.
              </p>
              <p>
                Our films champion scientists, artists, technologists and
                humanitarians in the fight against pressing global challenges,
                including poverty, disease, hunger and climate change.
              </p>
            </div>
