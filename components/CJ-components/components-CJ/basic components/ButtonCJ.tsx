...
const ButtonCJ: React.FC<ButtonCJProps> = ({
  ...
  const styles = {
    ...
    secondary: "text-base sans-serif custom-underline transition duration-150 ease-in-out hover:text-blue-800 dark:hover:text-blue-400 flex items-center group",
