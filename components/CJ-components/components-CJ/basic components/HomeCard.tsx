    ...
    return (
      <div>
        <div
          ...
          className="flex flex-row  items-center lg:block overflow-hidden group cursor-pointer"
        >
          ...
          <div className="pt-0 lg:pt-3 ml-3 lg:ml-0">
            <h3 className="sans-serif text-lg leading-snug pb-1 group-hover:underline">
              {title}
            </h3>
            <p
              className={`text-base sans-serif ${
                isWithSubtitle ? "block" : "hidden"
              } lg:block`}
            >
              {subtitle}
            </p>
