...
import { useEventContext } from "@/app/[locale]/(website)/events/event-context";
...
export const FilterComponentForEvents: React.FC = () => {
  const {
    programmes,
    setProgrammeFilter,
...
export default FilterComponentForEvents;
