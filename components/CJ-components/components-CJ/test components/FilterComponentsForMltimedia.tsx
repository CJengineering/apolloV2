...
import { useMultimediaContext } from "@/app/[locale]/(website)/multimedia/multimedia-context";
...
export const FilterComponentForMultimedia: React.FC = () => {
  const {
    programmes,
    people,
    setProgrammeFilter,
    ...
    <div className="w-full">
      ...
      <div className="w-full mb-1">
          ...
          <input
            ...
            type="text"
            placeholder="Search..."
            value={multimediaQuery}
            onChange={(e) => setMultimediaQuery(e.target.value)}
...
export default FilterComponentForMultimedia;
