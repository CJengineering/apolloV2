...
const Lightbox: React.FC<LightboxProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-95 flex items-center justify-center z-50 p-4 overflow-auto"
      onClick={onClose}
    >
      <div
        className="relative w-full max-w-6xl mx-auto p-4 overflow-hidden rounded-lg"
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div
            className={`sans-serif w-[90%] md:w-full text-white overflow-auto max-h-1/4`}
          >
