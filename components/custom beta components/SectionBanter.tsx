  ...
  return (
    <section className="mt-6 min-w-full ">
      <div className="w-full max-w-xl 0 sm:max-w-3xl lg:max-w-screen-2xl">
        {/* Section Header */}
        <h2 className="costa font-bold relative border-b border-gray-200 pb-2.5 text-2xl text-gray-900 before:absolute before:-bottom-px before:left-0 before:h-px before:w-24 before:bg-red-600 before:content-['']">
          {title}
        </h2>
