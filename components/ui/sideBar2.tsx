...
export default function Sidebar2() {
  ...
  return (
    ...
    as="aside"
    id="sidebar"
    className="fixed  left-0 top-0 bottom-0 w-60 h-screen border-r border-slate-200 md:left-auto md:shrink-0 z-10 md:!opacity-100 md:!block dark:border-slate-800 dark:bg-slate-900"
